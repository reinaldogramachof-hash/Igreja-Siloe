...
| SEC-01 | Auth, recuperação, convite e logout reais | 1 | 1 | Arquiteto + Dev Backend | Arquiteto | 1 | Execucao | correção autorizada (DEC-037) — Codex aplica `OT-SEC-01-CORRECOES.md` (1 crítico, 1 alto, 2 médios, 1 baixo da revisão de segurança); volta para `Revisao` quando entregar | branch tarefa/SEC-01-auth · OT-SEC-01-CORRECOES.md |
