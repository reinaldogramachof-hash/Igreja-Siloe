...
| TEN-01 | Organizações, vínculos e isolamento entre igrejas | 1 | 4 | Codex (exceção DEC-043) + Antigravity (tela) | Arquiteto | 1 | **Aprovada** | especificação fechada — DEC-041/042/043; SEC-01 em Revisão não bloqueia | TEN-01-ESPECIFICACAO.md |
