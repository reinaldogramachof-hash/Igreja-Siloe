...
| TEN-01 | Organizações, vínculos e isolamento entre igrejas | 1 | 4 | Arquiteto + Dev Backend | Arquiteto + Dev Frontend | 1 | Especificacao | SEC-01 (em Revisão, aguardando QA — não bloqueia a especificação) | TEN-01-ESPECIFICACAO.md (aguarda 3 respostas de Reinaldo) |
